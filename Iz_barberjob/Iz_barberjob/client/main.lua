...
--Use item
RegisterNetEvent("Iz_barbershop:barbershop_use")
AddEventHandler("Iz_barbershop:barbershop_use", function()
local target, distance = GetClosestPlayer()
				if(target ~= -1 and distance < 1.0) then
					TriggerServerEvent("Iz_barbershop:getSkin", target)
...
function getLimitationByGrade()
	local limitations = {
		...
		table.insert(limitations, 'beard_1')
		table.insert(limitations, 'beard_2')
		table.insert(limitations, 'beard_3')
		table.insert(limitations, 'beard_4')
