...
function OpenMobileActionsMenu()
	...
	ESX.UI.Menu.Open(
	'default', GetCurrentResourceName(), 'mobile_tattoo_actions',
	{
	title    = "Tatoueur",
	elements = {
			...
			function(data, menu)
				...
				if amount == nil then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'tattooshop', "Tatoueur", amount)
					end
				end
			end,
			function(data, menu)
